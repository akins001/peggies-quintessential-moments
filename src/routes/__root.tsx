  ...
  head: () => ({
    meta: [
      ...
      { title: "Peggies Events | Luxury Event Planning & Decor in Abuja" },
      {
        name: "description",
        content:
          "Peggies Events — luxury event planning, production and decor for weddings, corporate galas and milestone celebrations in Abuja, Nigeria.",
      },
      { name: "author", content: "Peggies Events" },
